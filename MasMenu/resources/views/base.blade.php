...
<body class="mb-5">
    ...
    <nav class="navegador p-3 p-md-4 w-100">
        ...
        <div class="elementosNav float-right">
            <!-- elementos publicos -->
            @if (Auth::guest())
                <a type="button" class="btn btn btn-outline-primary rounded activeSingup">Singup</a>
                <a type="button" class="btn btn btn-primary rounded activeLogin">Login</a>
            @else
                <!-- elementos privados -->
